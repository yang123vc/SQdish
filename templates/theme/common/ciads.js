...
$(document).ready(function(){
    ...
    $(".shxq .d4 li a").toggle(function(){
		ciads_fov($(this).offset(),"成功加入您的关注列表！");
        $(this).addClass('hover');
    },function(){
		ciads_fov($(this).offset(),"成功取消您的关注列表！");
        $(this).removeClass('hover');
	});

    $(".dishBoxRightContent .dishAddFavButton").toggle(function(){
		ciads_fov($(this).offset(),"成功加入您的关注列表！");
        $(this).addClass('hover');
    },function(){
		ciads_fov($(this).offset(),"成功取消您的关注列表！");
    ...
    $(".wrap .title .ts1 .ts13").toggle(function(){
		ciads_fov($(this).offset(),"成功加入您的关注列表！");
        $(this).addClass('hover');
    },function(){
		ciads_fov($(this).offset(),"成功取消您的关注列表！");
    ...
    $(".cpdp  .cpdp_u1 .li2").click(function(){
     ...
     $(".ctdp .top .a1").click(function(){
        $(".ctdp .top a").removeClass('hover');
        $(this).addClass('hover');
        $(".ctdp .d32").hide();
        $(".ctdp .d31").show();
    });
    $(".ctdp .top .a2").click(function(){
        $(".ctdp .top a").removeClass('hover');
        $(this).addClass('hover');
        $(".ctdp .d31").hide();
        $(".ctdp .d32").show();
...
$(document).ready(function(){
    ...
    $(".nnav .ttc .scroll ul li a").click(function(){
        $(".nnav .ttc .scroll ul li a").removeClass('hover');
        $(this).addClass('hover')
    });


    $(".nnav .ttc .scroll ul li").each(function(){
        var y =$(this).index();
        $(this).click(function(){
            $(".yj1 .nd").hide();
            $(".yj1 .nd:eq("+y+")").show();});
    ...
    $(".ynd .zrbd ul li .s3").click(function(){
        var x=($(this).text());
        x++
        $(this).text(x);
    });
    ...
    $(".help .wt ul li a .s2").hide();
    $(".help .wt ul li a").click(function(){
        $(this).find(".s2").toggle();
    });
...
$(function(){
    ...
    $(".rmtj2 .ttc .scroll").scrollable({size:1,items:".rmtj2 .ttc .scroll",loop:true}).navigator({navi:".rmtj2_u1",naviItem:"li",activeClass:"focus"});
...
$(function(){
    ...
    $(".bjr .ttc .scroll").scrollable({size:2,items:".bjr .ttc .scroll",loop:true}).navigator({navi:".bjr_u1",naviItem:"li",activeClass:"focus"});
...
$(function(){
    ...
    $(".yj .nnav .ttc .scroll").scrollable({size:2,items:"..yj .nnav .ttc .scroll",loop:false}).navigator({navi:"..yj .nnav_u1",naviItem:"li",activeClass:"focus"});

});

function ciads_fov(t,b)
{
	$(".ciads_fov2").css({"height":$(document).height()}).show();
	var z=setTimeout(function(){$(".ciads_fov").hide();$(".ciads_fov2").hide();},2000);
	$(".ciads_fov .d1 .s2").unbind("click").click(function(){
		$(".ciads_fov").hide();
		$(".ciads_fov2").hide();
		clearTimeout(z);
	});
	$(".ciads_fov .d2 .p1").text(b);
	$(".ciads_fov").css({"top":$(window).height()/2-90}).show();
