<?php
	...
	$sql = "select id,sellerName,tel,contacts,QRCode,dishPic,path,is_on from f_seller where sellerName like '%$key%' or sellerNameCN like '%$key%' or sellerNameTHAI like '%$key%' or contacts like '%$key%' or tel like '%$key%'";
	...
	include_once dirname(__FILE__)."/templates/SellerList.html";
