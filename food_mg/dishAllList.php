<?php
	...
	if(isset($_REQUEST['key'])){
		...
		$where = "where dishNameCN like '%$keyword%' or dishNameTHAI like '%$keyword%'";
	}	
	else{
		$where = "";
	}
	...
	$sql = "select * from f_dish $where order by id desc limit $location,$pageSize";

	$dishList = $db->get_all($sql);

	

	$sql = "select count(*) as count from f_dish $where order by id desc";
