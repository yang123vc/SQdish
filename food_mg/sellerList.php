<?php
	...
	$sql = "select id,sellerName,tel,contacts,QRCode,dishPic,path,is_on from f_seller order by id desc limit $location,$pageSize";
	...
	if($_SESSION[USERSESSION]['role']==3){
		include_once dirname(__FILE__)."/templates/refereeSellerList.html";
	}else{
